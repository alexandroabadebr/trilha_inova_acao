...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { alenco_atores: @filme.alenco_atores, ano_lancamento: @filme.ano_lancamento, comentarios: @filme.comentarios, titulo: @filme.titulo } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { alenco_atores: @filme.alenco_atores, ano_lancamento: @filme.ano_lancamento, comentarios: @filme.comentarios, titulo: @filme.titulo } }
