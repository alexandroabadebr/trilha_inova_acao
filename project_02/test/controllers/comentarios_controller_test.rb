...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { Filme_id: @comentario.Filme_id, comentario: @comentario.comentario } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { Filme_id: @comentario.Filme_id, comentario: @comentario.comentario } }
