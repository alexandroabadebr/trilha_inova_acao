...
class AtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ator" do
    assert_difference("Ator.count") do
      post ators_url, params: { ator: { Ator_id: @ator.Ator_id, ano_nascimento: @ator.ano_nascimento, email: @ator.email, nome: @ator.nome } }
    end
  ...
  test "should update ator" do
    patch ator_url(@ator), params: { ator: { Ator_id: @ator.Ator_id, ano_nascimento: @ator.ano_nascimento, email: @ator.email, nome: @ator.nome } }
